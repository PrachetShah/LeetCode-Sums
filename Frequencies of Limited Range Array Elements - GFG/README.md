...
<p><span style="font-size: 18px;">Can you solve this problem without using extra space (O(1) Space)?<br></span></p>
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ N&nbsp;≤ 10<sup>5</sup><br>1 ≤ P&nbsp;≤ 4*10<sup>4</sup><sup>&nbsp;</sup><br>1 &lt;= A[i] &lt;= P</span></p></div>